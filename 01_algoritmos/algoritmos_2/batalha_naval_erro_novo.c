...
void esc_pl(int tam_matriz, char (*jogo_player_hide)[tam_matriz]); // bug
void esc_pc(int tam_matriz, char (*jogo_pc_hide)[tam_matriz]);     // bug
...
int derrubar_bichinho(int tam_matriz, char (*jogo_hide)[tam_matriz], int player_pc, int *navio, int *porta, int *hidro); // bom o suficiente
...
int main()
{
    ...
    do
    {
        ...
        char **jogo_player, **jogo_pc;
        char **jogo_pc_hide, **jogo_player_hide;
        ...
        jogo_player = malloc(tam_matriz * sizeof(int *));
        jogo_pc = malloc(tam_matriz * sizeof(int *));
        jogo_pc_hide = malloc(tam_matriz * sizeof(int *));
        jogo_player_hide = malloc(tam_matriz * sizeof(int *));

        jogo_player[0] = malloc(tam_matriz * tam_matriz * sizeof(int));
        jogo_pc[0] = malloc(tam_matriz * tam_matriz * sizeof(int));
        jogo_pc_hide[0] = malloc(tam_matriz * tam_matriz * sizeof(int));
        jogo_player_hide[0] = malloc(tam_matriz * tam_matriz * sizeof(int));

        for (i = 1; i < tam_matriz; i++)
        {
            jogo_player[i] = jogo_player[0] + i * tam_matriz;
            jogo_pc[i] = jogo_pc[0] + i * tam_matriz;
            jogo_pc_hide[i] = jogo_pc_hide[0] + i * tam_matriz;
            jogo_player_hide[i] = jogo_player_hide[0] + i * tam_matriz;
        }
        ...
        free(jogo_pc_hide[0]);
        free(jogo_pc_hide);
        free(jogo_player_hide[0]);
        free(jogo_player_hide);
    } while (newgame == 1);
...
void esc_pc(int tam_matriz, char (*jogo_pc_hide)[tam_matriz])
{
    ...
    do
    {
        ...
        if (jogo_pc_hide[linha][coluna] == 'O')
        {
            cima_baixo = rand() % 2; // 0 vertical, 1 horizontal

            if (cima_baixo == 0) // vertical
            {
                if (jogo_pc_hide[linha - 1][coluna] == 'O' && jogo_pc_hide[linha + 1][coluna] == 'O')
                {
            ...
            {
                if (jogo_pc_hide[linha][coluna - 1] == 'O' && jogo_pc_hide[linha][coluna + 1] == 'O')
                {
...
void esc_pl(int tam_matriz, char (*jogo_player_hide)[tam_matriz])
{
        ...
        if (h_ou_v == 'H')
        {
            do
            {
                do
                {
                    ...
                    por_l--;
                    por_c--;
                    if ((por_c < 1 && por_l < 1) || (por_c > tam_matriz - 2 && por_l > tam_matriz - 2))
                    {
                        printf("Posição inválida.\n");
                    }
                } while ((por_c < 1 && por_l < 1) || (por_c > tam_matriz - 2 && por_l > tam_matriz - 2));
                if (jogo_player_hide[por_l][por_c] == 'N' || jogo_player_hide[por_l][por_c - 1] == 'N' || jogo_player_hide[por_l][por_c + 1] == 'N')
                {
        ...
        else
        {
            do
            {
                do
                {
                    ...
                    por_l--;
                    por_c--;
                    if ((por_c < 2 && por_l < 1) || (por_c > tam_matriz - 3 && por_l > tam_matriz - 2))
                    {
                        printf("Posição inválida.\n");
                    }
                } while ((por_c < 2 && por_l < 1) || (por_c > tam_matriz - 3 && por_l > tam_matriz - 2));
                if (jogo_player_hide[por_l][por_c] == 'N' || jogo_player_hide[por_l - 1][por_c] == 'N' || jogo_player_hide[por_l + 1][por_c] == 'N')
                {
                    printf("Posição Ocupada.\n");
                }
    ...
    if (h_ou_v == 'H')
    {
        do
        {
            do
            {
                ...
                por_l--;
                por_c--;
                if (por_c < 1 || por_l < 1 || por_c > tam_matriz - 3 || por_l > tam_matriz - 1)
                {
                    printf("Posição inválida.\n");
                }
            } while (por_c < 1 || por_l < 1 || por_c > tam_matriz - 3 || por_l > tam_matriz - 1);
            if (jogo_player_hide[por_l][por_c] != ' ' || jogo_player_hide[por_l][por_c - 1] != ' ' || jogo_player_hide[por_l][por_c + 1] != ' ' || jogo_player_hide[por_l][por_c + 2] != ' ')
            {
                printf("Posição Ocupada.\n");
            }
    ...
    else // vertical
    {
        do
        {
            do
            {
                ...
                por_l--;
                por_c--;
                if (por_c < 0 || por_l < 1 || por_c > tam_matriz - 1 || por_l > tam_matriz - 3)
                {
                    printf("Posição inválida.\n");
                }
            } while (por_c < 0 || por_l < 1 || por_c > tam_matriz - 1 || por_l > tam_matriz - 3);
            if (jogo_player_hide[por_l][por_c] == 'N' || jogo_player_hide[por_l - 1][por_c] == 'N' || jogo_player_hide[por_l + 1][por_c] == 'N' || jogo_player_hide[por_l + 2][por_c] == 'N')
            {
                printf("Posição Ocupada.\n");
            }
    ...
    for (k = 0; k < 2; k++) //@ hidroavião
    {
        ...
        if (h_ou_v == 'H')
        {
            do
            {
                do
                {
                    ...
                    por_l--;
                    por_c--;
                    if ((por_c < 1 && por_l < 1) || por_c > tam_matriz - 1 || por_l > tam_matriz - 2)
                    {
                        printf("Posição inválida.\n");
                    }
                } while ((por_c < 1 && por_l < 1) || por_c > tam_matriz - 1 || por_l > tam_matriz - 2);
                if (jogo_player_hide[por_l][por_c] != ' ' || jogo_player_hide[por_l][por_c - 1] != ' ' || jogo_player_hide[por_l][por_c + 1] != ' ' || jogo_player_hide[por_l + 1][por_c] != ' ' || jogo_player_hide[por_l + 1][por_c - 1] != ' ' || jogo_player_hide[por_l + 1][por_c + 1] != ' ')
                {
                    printf("Posição Ocupada.\n");
                }
        ...
        {
            do
            { // todo: aqui ta bugado (player tava desenhando hidro vertical diferente)
                do
                {
                    printf("2ª casa do Hidroavião (linha): ");
                    scanf("%d%*c", &por_l);
                    ...
                    por_l--;
                    por_c--;
                    if ((por_c < 2 && por_l < 1) || por_c > tam_matriz - 1 || por_l > tam_matriz - 2)
                    {
                        printf("Posição inválida.\n");
                    }
                } while ((por_c < 2 && por_l < 1) || por_c > tam_matriz - 1 || por_l > tam_matriz - 2);
                if (jogo_player_hide[por_l][por_c] != ' ' || jogo_player_hide[por_l - 1][por_c] != ' ' || jogo_player_hide[por_l + 1][por_c] != ' ' || jogo_player_hide[por_l - 1][por_c - 1] != ' ' || jogo_player_hide[por_l][por_c - 1] != ' ' || jogo_player_hide[por_l + 1][por_c - 1] != ' ')
                {
                    printf("Posição Ocupada.\n");
                }
...
int vez_player(int tam_matriz, char (*jogo_player)[tam_matriz], char (*jogo_pc)[tam_matriz], char (*jogo_pc_hide)[tam_matriz])
{
    ...
    do
    {
        do
        {
            ...
            linha--;
            coluna--;
            if ((coluna < 0 && linha < 0) || (coluna > tam_matriz - 1 && linha > tam_matriz - 1))
            {
                printf("Posição inválida.\n");
            }
        } while ((coluna < 0 && linha < 0) || (coluna > tam_matriz - 1 && linha > tam_matriz - 1));
    ...
    if (jogo_pc_hide[linha][coluna] == 'O' || jogo_pc_hide[linha][coluna] == '-')
    {
        jogo_player[linha][coluna] = '-';
        printf("Você errou.\n");
        return 1; // ir para pc
    }
    else if (jogo_pc_hide[linha][coluna] == 'N' || jogo_pc_hide[linha][coluna] == 'P' || jogo_pc_hide[linha][coluna] == 'H')
    {
...
int vez_pc(int tam_matriz, char (*jogo_player)[tam_matriz], char (*jogo_pc)[tam_matriz], char (*jogo_player_hide)[tam_matriz])
{
    ...
    linha = rand() % tam_matriz - 1;
    coluna = rand() % tam_matriz - 1;

    if (jogo_player_hide[linha][coluna] == ' ')
    {
    ...
    for (i = 0; i < tam_matriz; i++)
    {
        for (j = 0; j < tam_matriz; j++)
        {
            if (jogo_hide[i][j] == 'X')
            {
                ...
                {
                    if (jogo_hide[i][j + 2] == 'X' && jogo_hide[i][j + 3] == 'X') // porta hor
                    {
                        *porta -= 1;
                        jogo_hide[i][j] = 'O';
                        jogo_hide[i][j + 1] = 'O';
                ...
                {
                    if (jogo_hide[i + 2][j] == 'X' && jogo_hide[i + 3][j] == 'X') // porta vert
                    {
                        *porta -= 1;
                        jogo_hide[i][j] = 'O';
                        jogo_hide[i + 1][j] = 'O';
                ...
                else if (jogo_hide[i + 1][j - 1] == 'X' && jogo_hide[i + 2][j] == 'X') // hidro vert
                {
                    if (jogo_hide[i][j - 1] == '-' && jogo_hide[i + 1][j] == '-' && jogo_hide[i + 2][j - 1] == '-')
                    {
                        *hidro -= 1;
                        jogo_hide[i][j] = 'O';
                        jogo_hide[i + 1][j - 1] = 'O';
                ...
                else if (jogo_hide[i + 1][j - 1] == 'X' && jogo_hide[i + 1][j + 1] == 'X') // hidro horiz
                {
                    if (jogo_hide[i][j - 1] == '-' && jogo_hide[i][j + 1] == '-' && jogo_hide[i + 1][j] == '-')
                    {
                        *hidro -= 1;
                        jogo_hide[i][j] = 'O';
                        jogo_hide[i + 1][j - 1] = 'O';
...
void rank(int vit1, int vit2) // ver se ta dando erro we
{
    setlocale(LC_ALL, "portuguese");
    FILE *arq;
    int erro_arq;
    ...
    player.nick[strlen(player.nick) - 1] = 0;

    sprintf(string_vit1, "%d", vit1); // converter o inteiro em char
...
//@ matriz 10x10 ou 15x15 (2 e 2 opções)
//$ navio (3 espaço), porta aviões (4 espaço), hidroviazinhos (baixo cima baixo) para o pc

//! escolher onde por as coisas (2 navios, 1 porta, 2 água)
//! sorteia as posições q o pc da pra ele e
//@ sorteia quem começa primeiro

//@ - tiro na água, X para tiro certo
//@ vence quem derrubar 3 primeiro

//@encerrar ou novo jojo